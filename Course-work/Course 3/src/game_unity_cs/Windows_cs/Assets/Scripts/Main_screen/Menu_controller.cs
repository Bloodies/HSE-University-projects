...
[RequireComponent(typeof(Settings_controller))]
[RequireComponent(typeof(Language_controller))]
[RequireComponent(typeof(Menu_select))]
[RequireComponent(typeof(Level_select))]
[RequireComponent(typeof(UITransition))]
public class Menu_controller : Keys_config
{
	...
	public new AudioSource[] audio = new AudioSource[0];
	...
	#region START METHODS MENU CONTROL	
	void basicSettings()	// Set the basics settings
	{
	...
	#endregion END METHODS MENU CONTROL
	...
	#region START METHODS PLAY, MODES, LEVEL SCREEN	
    ...
    //[System.Obsolete]
    public void loadLevelGame()		// Loads game level
	{
	...
	void quitModesScreen()			// Updating the Modes Exit Button
	{
	...
	void quitLevelScreen()			// Updating the Level Exit Button
	{
		// If you press the "esc" key and the modes screen is active
	...
	void setModesScreen(bool value)	// Changes between the main screen and the modes screen
	{
		if (value)
		{
	...
	void setLevelScreen(bool value)	// Changes between the main screen and the level select screen
	{
		if (value)
		{
			mainScreen.SetActive(false);                                            // Disables the Main Screen
	...
	#endregion END METHODS PLAY/MODES SCREEN

	#region START METHODS CREDITS SCREEN	
	void firstCreditsSettings()				// Starts initial credit settings
	{
	...
	void updateAnimScaleCredits()			// Update the scale animation of credits
	{
		if (animationType == CreditsAnimationType.Scale)
	...
	void quitScreenCredits()				// Updating the Credits Exit Button
	{
	...
	void updateAnimDirectionCredits()		// Update the direction animation of credits
	{
	...
	public void setCreditsScreen(bool value)	// Changes between the main screen and the credits screen
	{
	...
	#endregion END METHODS CREDITS SCREEN

	#region START METHODS OPTIONS SCREENS
	...
	#endregion END METHODS OPTIONS SCREENS	
	
	public void playAudio(int index)	// Play audio by index in list FX
	{
		audio[index].Play();
	}
	
	public void playBackgroundAudio()	// Play background FX
	{
