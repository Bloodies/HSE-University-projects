...
def create_widgets_in_first_frame():
    ...
    first_window_label = tkinter.ttk.Label(first_frame, text='Choose Language')
    ...
    create_widgets_in_first_frame.add_img = tkinter.PhotoImage(file="ru.png")
    create_widgets_in_second_frame.add_img = tkinter.PhotoImage(file="ch.png")
    create_widgets_in_third_frame.add_img = tkinter.PhotoImage(file="eng.png")
    create_widgets_in_fourth_frame.add_img = tkinter.PhotoImage(file="fr.png")
