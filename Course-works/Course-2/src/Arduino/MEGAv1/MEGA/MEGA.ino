...
const char* topic_pub_pingdev   = "device/cmd/pingstatus/5473f20f-05de-4e75-91af-686490030c38";
const char* topic_sub_pingdev   = "device/cmd/5473f20f-05de-4e75-91af-686490030c38";

const char* topic_pub_pingserv  = "server/cmd/5473f20f-05de-4e75-91af-686490030c38";
const char* topic_sub_pingserv  = "server/cmd/pingstatus/5473f20f-05de-4e75-91af-686490030c38";

const char* topic_pub_reg       = "server/registration/5473f20f-05de-4e75-91af-686490030c38";
const char* topic_sub_reg       = "server/registration/status/5473f20f-05de-4e75-91af-686490030c38";

const char* topic_pub_devstatus = "device/cmd/devstatus/5473f20f-05de-4e75-91af-686490030c38";
const char* topic_sub_devstatus = "device/cmd/5473f20f-05de-4e75-91af-686490030c38";

const char* topic_pub_variables = "device/variables/status/5473f20f-05de-4e75-91af-686490030c38";
const char* topic_sub_variables = "device/cmd/5473f20f-05de-4e75-91af-686490030c38";

const char* topic_sub_config    = "device/variables/config/5473f20f-05de-4e75-91af-686490030c38";
const char* topic_pub_config    = "device/variables/status/5473f20f-05de-4e75-91af-686490030c38";

const char* topic_sub_vardata   = "server/status/5473f20f-05de-4e75-91af-686490030c38";
const char* topic_pub_vardata   = "device/variables/5473f20f-05de-4e75-91af-686490030c38";
...
void connect() {
  ...
  client.subscribe(topic_sub_pingdev);
  client.subscribe(topic_sub_pingserv);
  client.subscribe(topic_sub_reg);
  client.subscribe(topic_sub_devstatus);
  client.subscribe(topic_sub_variables);
  client.subscribe(topic_sub_config);
  client.subscribe(topic_sub_vardata);
