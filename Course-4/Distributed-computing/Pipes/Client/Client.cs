...
namespace Client
{
    public partial class Client : Form
    {
        ...
        private void SendMessage(string text)
        {
            ...
            byte[] buff = Encoding.Unicode.GetBytes(login + ": " + text);    // выполняем преобразование сообщения (вместе с идентификатором машины) в последовательность байт
